...
exports.fetchBanks = asyncHandler(async (req, res) => {
  return res.status(200).json({ data: banks });
});

exports.gotvPlans = asyncHandler(async (req, res) => {
  return res.status(200).json({ data: gotv });
});

exports.dstvPlans = asyncHandler(async (req, res) => {
  return res.status(200).json({ data: dstv });
});

exports.kwesePlans = asyncHandler(async (req, res) => {
